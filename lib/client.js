...
window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		function ZhihuSearchView(props) {
			...
			return react.createElement(ToolShell, { title, iconChar, iconBg, badge: tone(items.length + " 条" + (hasMore ? " · 还有更多" : ""), "brand"), headRight, foot: data && data.SearchHashId ? "SearchHashId: " + data.SearchHashId : (hasMore ? "还有更多结果，可翻页" : ""), argsRaw: bt.argsRaw },
